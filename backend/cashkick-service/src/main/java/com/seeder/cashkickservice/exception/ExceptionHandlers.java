...
public class ExceptionHandlers {
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handleException(CashKickNotFoundException exc) {
    ...
    @ExceptionHandler
    public ResponseEntity<ErrorResponse> handleCashKickAlreadyExistsException(CashKickAlreadyExistsException exc) {
